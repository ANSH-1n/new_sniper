...
//       mount.removeChild(renderer.domElement); // Use local variable
//     };
//   }, []);
...
export default function SniperCodersWebsite() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      requestAnimationFrame(animate);
      particles.rotation.y += 0.002;
      // Camera animation as an alternative to OrbitControls
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-egy500">
                  {card.title}
                </h3>
                <p className="text-gray-300 mb-8 relative z-10">
                  {card.description}
