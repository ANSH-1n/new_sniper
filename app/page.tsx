...
export default function Home(): React.ReactElement {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 15; i++) {
      ...
      const sphere: THREE.Mesh<THREE.SphereGeometry, THREE.MeshPhongMaterial> =
    ...
    const pointLight1: THREE.PointLight = new THREE.PointLight(
      0xff9dff,
      1,
      100
    );
    ...
    const pointLight2: THREE.PointLight = new THREE.PointLight(
      0x4a9fff,
      1,
      100
    );
