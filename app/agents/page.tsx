...
const AIAgentsLandingPage: React.FC = () => {
  ...
  return (
    <div className="relative bg-[#0a0a2e] text-white min-h-screen overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 md:px-10 flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 lg:pr-8" data-aos="fade-right">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="border border-purple-500 hover:bg-purple-800/20 text-white font-bold py-3 px-8 rounded-full transition duration-300">
                Learn More
              </button>
            </div>
          </div>
      ...
      {/* New Section: Scale Your Social Presence */}
      ...
      {/* New Section: Simple Steps to Social Media Mastery */}
      {/* <section className="relative z-10 py-24">
        <div className="container mx-auto px-4 md:px-10">
          <h2
            className="text-5xl font-bold text-center mb-16 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500"
            data-aos="fade-up"
          >
            Simple Steps to Social Media Mastery
          </h2>
          <ol className="space-y-6 max-w-3xl mx-auto">
            <li className="text-xl" data-aos="fade-up" data-aos-delay="100">
              ...
              Securely link all your social media profiles to our platform.
            </li>
            <li className="text-xl" data-aos="fade-up" data-aos-delay="200">
              <span className="font-bold text-purple-400">
                2. Create & Automate:
              </span>{" "}
              Utilize our AI tools to generate posts and captions, or craft your
              own content. Set up your DM automation rules.
            </li>
            <li className="text-xl" data-aos="fade-up" data-aos-delay="300">
              <span className="font-bold text-purple-400">
                3. Schedule & Publish:
              </span>{" "}
              Plan your posts with our intuitive scheduler for optimal times
            ...
            <li className="text-xl" data-aos="fade-up" data-aos-delay="400">
              ...
              Monitor your results and engage with your audience (if
              applicable).
            </li>
          </ol>
          <div
      ...
      <section className="relative z-10 py-24">
        <div className="container mx-auto px-4 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            ].map(({ quote, name, title, delay }, index) => (
              <div
                key={index}
